...
@section('content')
<table class="table">
  <a href="{{route("comics.create")}}"><button type="button" class="btn btn-secondary">Crea nuovo</button></a>
  <thead>
      <tr>
        <th scope="col">#</th>
    ...
    <tbody>
        ...
        <tr>
          ...
          <td>{{$elemento->type}}</th>
          <td>
            <a href="{{route("comics.show", $elemento->id)}}"><button type="button" class="btn btn-primary">Info</button></a>
